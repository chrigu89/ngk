...
class APNotification extends APNSBase{
  ...
  public function send()
  {
    ...
    $fp = stream_socket_client(APNotification::$_ENVIROMENTS[$this->_enviroment],$errorNumber,$errorString,60,STREAM_CLIENT_CONNECT,$streamContext);
        
    if($fp){ echo $fp;} else{ echo 'NO';}
