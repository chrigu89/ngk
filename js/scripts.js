...
function pdf(url) {
	...
	if (navigator.userAgent.match(/(Android)/)) {
        var ref = window.open("https://docs.google.com/gview?embedded=true&url=" + "http://apps.apfel.gold/ngk/" + url, '_blank', 'location=yes,enableViewPortScale=yes');
